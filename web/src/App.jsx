...
import { campusMapMeta, categories, locationAliases, locations } from './data.js';
import {
  claimCloudItem,
  clearUser,
  cloudErrorMessage,
...
function App() {
  ...
  useEffect(() => {
    ...
    if (typeof window.requestIdleCallback === 'function') {
      idleId = window.requestIdleCallback(startSync, { timeout: 1200 });
    } else {
      timeoutId = window.setTimeout(startSync, 300);
    }
